...
(function () {
    ...
    /*
     * 两个源的路径不一样，不是笔误：
     * Pages 是发布出来的站点，主题仍在站点根的 themes/（老地址不能变，用户 @import 的就是它）；
     * githack 直读仓库，仓库里主题已经挪进 legacy/ 了。
     */
    const PAGES = REPO_PAGES + 'themes/'
    const GITHACK = REPO_GITHACK + 'legacy/themes/'
        ...
        const JS_MODES = [
            {
                ...
                get: () => 'import("' + REPO_GITHACK + 'legacy/js/' + jsFile + '")',
            },
            {
                label: '复制 JS 全文',
